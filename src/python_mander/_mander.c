...
#else
    module = Py_InitModule3("python_mander._mander", module_functions, NULL);
#endif
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_mander(void) {
    moduleinit();
}
#else
PyMODINIT_FUNC PyInit__mander(void) {
    return moduleinit();
}
#endif
